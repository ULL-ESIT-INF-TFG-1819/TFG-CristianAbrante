...
Esta interfaz \texttt{GeneratorParams} deberá ser también extendida para indicar los parámteros concretos del generador. \\
...
Una vez se ha desarrollado \texttt{NumericGenerator} como generador numérico fundamental, es bastante sencillo extender dicha clase para crear un generador de individuos de números enteros (\texttt{IntegerGenerator}) y de números en punto floatante (\texttt{FloatingGenerator}). \\
